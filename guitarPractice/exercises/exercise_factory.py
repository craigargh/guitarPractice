...
def lead_rhythm_exercises():
    key = 'lead-rhythm'
    name = 'Lead Rhythm'
    description = 'Practice rhythmic picking with scales'

    group = ExerciseGroup(key, name, description)
    group[1] = lead_rhythm.level_one
    group[2] = lead_rhythm.level_two
